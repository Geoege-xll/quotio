...
**2026-09-17 选择性同步**：已配置原作者 `upstream`，从 `0.31.0` 基线对比到 `v0.32.0` 及 `73c383e`。按用户选择保留当前架构、移植适用修复；采用项、已覆盖项及暂缓项见[本次比对记录](upstream-sync/2026-09-17.md)。以下早期仓库状态是历史记录，不代表当前仍未配置上游。
